...
Plan and aircraft-profile import/export are explicitly out of scope before version 1.0. Keep pilot inputs and profiles in the current browser's local store; do not add recovery files or portability controls.
